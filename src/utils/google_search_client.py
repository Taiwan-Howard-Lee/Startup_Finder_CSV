...
class GoogleSearchClient:
    ...
    def search_startups(self, query: str, num_results: int = 5) -> List[Dict[str, str]]:
        """
        ...
        # Search for startups
        search_results = self.search(startup_query, num_results * 2)  # Get more results than needed
